...
export const setupCLI = (startServerCallback) => {
    return yargs(hideBin(process.argv))
        .command("start", "Start Server", {}, startServerCallback)
        ...
        .command("revert <commitID>", "Revert changes in the repository", (yargs) => {
            yargs.positional("commitID", { describe: "Commit message", type: "string" });
        }, revertRepo)
